...
if __name__ == '__main__':
    ...
    ir_path = "../dataset/train/RoadScene/ir"  # for ori svs maps
    vi_path = "../dataset/train/RoadScene/vis"

    ir_file_list = sorted(os.listdir(ir_path))
    vi_file_list = sorted(os.listdir(vi_path))

    ir_map_path = "../dataset/train/svs_map/ir_map"
    vi_map_path = "../dataset/train/svs_map/vi_map"
